!function(e) {
    ...
    a.prototype.init=function() {
        ...
        this.createBarChart("morris-bar-example", [ {
            y: "2019-10-19", a: 100, b: 90, c: 32, d: 11, e: 34, f: 43
        }
        , {
            y: "2019-10-20", a: 75, b: 65, c: 43, d: 43, e: 34, f: 43
        }
        , {
            y: "2019-10-21", a: 50, b: 40, c: 55, d: 11, e: 34, f: 43
        }
        , {
            y: "2019-10-22", a: 75, b: 65, c: 52, d: 34, e: 11, f: 43
        }
        , {
            y: "2019-10-23", a: 50, b: 40, c: 49, d: 11, e: 34, f: 43
        }
        ], "y", ["a", "b", "c", "d", "e", "f"], ["Like", "Love", "Haha", "Wow", "Sad", "Angry"], ["#5b6be8", "#0097a7", "#0cb0c2"]);
