...
!function(e) {
    ...
    a.prototype.init=function() {
        this.createLineChart("morris-line-example-1", [ {
            y: "2019-10-19", a: datam[0]
        }
        , {
            y: "2019-10-20", a: datam[1]
        }
        , {
            y: "2019-10-21", a: datam[2]
        }
        , {
            y: "2019-10-22", a: datam[3]
        }
        , {
            y: "2019-10-23", a: datam[4]
        }
        ], "y", ["a"], ["New Follower"], ["#5b6be8"]);
        this.createLineChart("morris-line-example-2", [ {
            y: "2019-10-19", a: 100
        }
        , {
            y: "2019-10-20", a: 75
        ...
        this.createBarChart("morris-bar-example-1", [ {
            y: "2019-10-19", a: 88
        }
        , {
            y: "2019-10-20", a: 75
        ...
        this.createBarChart("morris-bar-example-2", [ {
            y: "2019-10-19", a: 100
        }
        , {
            y: "2019-10-20", a: 75
