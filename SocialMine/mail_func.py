...
def send_verify_email(email, verification_link):
	smtp = smtplib.SMTP()
		...
		<div style="max-width: 600px; margin: 0 auto;" class="email-container">
		  ...
		  <table align="center" role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%" style="margin: auto;">
			<tr>
				...
				<table role="presentation" border="0" cellpadding="0" cellspacing="0" width="100%">
					<tr>
						<td valign="middle" class="logo" style="text-align: center;">
							<h1><a href="https://adinnovation.org"><img src="https://i.ibb.co/nRMHXxC/adi-logo.png"></a></h1>
						  </td>
					</tr>
				</table>
			  </td>
			  ...
			  <tr>
			  <td valign="middle" class="hero bg_white" style="background-size: cover; height: 200px;">
				<div class="overlay"></div>
				<table>
					<tr>
						<td>
							<div class="text" style="padding: 0 4em; text-align: center;">
								<h2>SocialMine.net</h2>
								<p>Brainstorming for desired perfect Usability</p>
								<p>Our analytics tools are fresh, simple, and will greatly benefit your opportunity for growth. </p>
	"""
	mail_txt_2 = '<p><a href="{verification_link}" class="btn btn-primary">Verify Email</a></p>'.format(verification_link=verification_link)
	mail_txt_3 = """
							</div>
						</td>
					</tr>
					  ...
					  <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
						<tr>
						  <td style="text-align: center;">
							<p>Click Verify Email to get access to SocialMine tools</p>
						  </td>
						</tr>
						<tr>
						  <td style="text-align: center;">
							<p>&copy; 2019. All rights reserved by <a href="https://adinnovation.org">Aggregate Digital Innovation LLC</a></p>
						  </td>
						</tr>
					  </table>
					</td>
